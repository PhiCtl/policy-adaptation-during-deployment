...
def main(args):
    ...
    prepare_BCA(training_env, agent, replay_buffer, args.pad_num_episodes)
    ...
    eval_reward, std = evaluate(env, agent, clone_agent, replay_buffer, args, video, recorder, adapt=False, bca=False)
